 ...
 */
public class PlayerTwoWin extends JFrame {
    JLabel p1lbl;
    JButton RESETbtn;
    JButton exitbtn;
    ...
    public PlayerTwoWin() {
        ...
        p1lbl = new JLabel("Player Two WIN");
        ...
        RESETbtn.addActionListener(new Button3ActionListener());
        exitbtn.addActionListener(new
                Button4ActionListener());
    ...
    class Button4ActionListener extends JFrame implements ActionListener {
